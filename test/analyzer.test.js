...
const semanticErrors = [
  ...
  ["Assigning function to variable", "f func(){} mu x: func"],
  ...
  ["Array index not integer", "im x: [1 2 3] p(x[true])"],
  ["Array index out of bounds", "im x: [1 2 3] p(x[10])"],
